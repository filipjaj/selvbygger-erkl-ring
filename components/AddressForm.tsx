...
const AddressForm = () => {
  ...
  const [selectedTab, setSelectedTab] = useState<"søk" | "skjema">("søk");
    ...
    <Form {...form}>
      <Tabs defaultValue="søk" className="w-full" value={selectedTab}>
        <TabsList>
          ...
          <TabsTrigger value="skjema" onClick={() => setSelectedTab("skjema")}>
            Skjema
          </TabsTrigger>
        </TabsList>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="10" {...field} className="w-16" />
                    </FormControl>
                    <FormDescription />
                    <FormMessage />
                  </FormItem>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input {...field} placeholder="0000" className="w-20" />
                    </FormControl>
                    <FormDescription />
                    <FormMessage />
                  </FormItem>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="0" {...field} className="w-20" />
                  </FormControl>
                  <FormDescription />
                  <FormMessage />
                </FormItem>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="00" {...field} className="w-20" />
                    </FormControl>
                    <FormDescription />
                    <FormMessage />
                  </FormItem>
